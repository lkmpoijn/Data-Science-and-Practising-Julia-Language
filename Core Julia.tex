...
\end{Verbatim}
    ...
    Strings can be comared lexicographically using comarsion operators, e.g.
\texttt{==}, \texttt{\textgreater{}}, etc. Lexicograohical comparison
involves sequentially comparing string elements with the same position,
until one pair of elements falsiies the comparison, or the end of the
...
Note that \texttt{?\ :} is called the "ternary operator", it assocaites
from right to left, and it can be useful for short conditional
statements. Ternary operators cna be chained together to accommodate
situations analogous to an \texttt{if-elseif-else} construct with one or
more \texttt{ifelse} blocks.
...
and Lange (2000,2004)} for further details.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{c}{\PYZsh{}\PYZsh{} A function with a keyword argument}
        \PY{c}{\PYZsh{}\PYZsh{} Argument after the ; are keyword argumennts}
        \PY{c}{\PYZsh{}\PYZsh{} The default values are evaluated from left\PYZhy{}to\PYZhy{}right}
        \PY{c}{\PYZsh{}\PYZsh{} This allows keyword arguments to refer previously defined keywords}
        \PY{c}{\PYZsh{}\PYZsh{} Keyword arguments can have explicit types}
        
        \PY{c}{\PYZsh{}\PYZsh{} estimate the median of a 1D array using an MM algorithm}
        \PY{c}{\PYZsh{}\PYZsh{} for clarity (too many m\PYZsq{}s!) we use an \PYZus{} in the function name}
        
        \PY{k}{function} \PY{n}{mm\PYZus{}median}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{eps}\PY{o}{=}\PY{l+m+mf}{0.001}\PY{p}{;}\PY{n}{maxit}\PY{o}{=}\PY{l+m+mi}{25}\PY{p}{,} \PY{n}{iter}\PY{o}{::}\PY{k+kt}{Int64}\PY{o}{=}\PY{k+kt}{Int}\PY{p}{(}\PY{n}{floor}\PY{p}{(}\PY{n}{eps}\PY{p}{)}\PY{p}{)}\PY{p}{)}
            
            \PY{c}{\PYZsh{}\PYZsh{} initalizations}
            \PY{n}{psi} \PY{o}{=} \PY{n}{fill!}\PY{p}{(}\PY{k+kt}{Vector}\PY{p}{\PYZob{}}\PY{k+kt}{Float64}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{n}{undef}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}\PY{l+m+mf}{1e2}\PY{p}{)}
            
            \PY{k}{while}\PY{p}{(}\PY{k+kc}{true}\PY{p}{)}
                \PY{n}{iter} \PY{o}{+=} \PY{l+m+mi}{1}
                \PY{k}{if} \PY{n}{iter} \PY{o}{==} \PY{n}{maxit}
                    \PY{n}{println}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{M}\PY{l+s}{a}\PY{l+s}{x}\PY{l+s}{ }\PY{l+s}{i}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{ }\PY{l+s}{r}\PY{l+s}{e}\PY{l+s}{a}\PY{l+s}{c}\PY{l+s}{h}\PY{l+s}{e}\PY{l+s}{d}\PY{l+s}{ }\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{ }\PY{l+s}{i}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{=}\PY{l+s+si}{\PYZdl{}iter}\PY{l+s}{\PYZdq{}}\PY{p}{)}
                    \PY{k}{break}
                \PY{k}{end}
                \PY{n}{num}\PY{p}{,} \PY{n}{den} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{)}
                \PY{c}{\PYZsh{}\PYZsh{} use map() to  do elementwise operations in wgt}
                \PY{n}{wgt} \PY{o}{=} \PY{n}{map}\PY{p}{(}\PY{n}{d} \PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}} \PY{p}{(}\PY{n}{abs}\PY{p}{(}\PY{n}{d} \PY{o}{\PYZhy{}} \PY{n}{psi}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}\PY{p}{)}\PY{o}{\PYZca{}}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,}\PY{n}{x}\PY{p}{)}
                \PY{n}{num} \PY{o}{=} \PY{n}{sum}\PY{p}{(}\PY{n}{map}\PY{p}{(}\PY{o}{*}\PY{p}{,}\PY{n}{wgt}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{)}
                \PY{n}{den} \PY{o}{=} \PY{n}{sum}\PY{p}{(}\PY{n}{wgt}\PY{p}{)}
                \PY{n}{psi} \PY{o}{=} \PY{n}{circshift}\PY{p}{(}\PY{n}{psi}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
                \PY{n}{psi}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]} \PY{o}{=} \PY{n}{num}\PY{o}{/}\PY{n}{den}
                
                \PY{n}{dif} \PY{o}{=} \PY{n}{abs}\PY{p}{(}\PY{n}{psi}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{o}{\PYZhy{}}\PY{n}{psi}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                \PY{k}{if} \PY{n}{dif} \PY{o}{\PYZlt{}} \PY{n}{eps}
                    \PY{n}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{C}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{v}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{g}\PY{l+s}{e}\PY{l+s}{d}\PY{l+s}{ }\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{ }\PY{l+s}{i}\PY{l+s}{t}\PY{l+s}{e}\PY{l+s}{r}\PY{l+s}{a}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{ }\PY{l+s+si}{\PYZdl{}iter}\PY{l+s}{\PYZdq{}}\PY{p}{)}
                    \PY{k}{break}
                \PY{k}{end}
            \PY{k}{end}
            
            \PY{k}{return}\PY{p}{(}\PY{k+kt}{Dict}\PY{p}{(}
                    \PY{l+s}{\PYZdq{}}\PY{l+s}{p}\PY{l+s}{s}\PY{l+s}{i}\PY{l+s}{\PYZus{}}\PY{l+s}{v}\PY{l+s}{e}\PY{l+s}{c}\PY{l+s}{\PYZdq{}}\PY{o}{=\PYZgt{}} \PY{n}{psi}\PY{p}{,}
                    \PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{d}\PY{l+s}{i}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{\PYZdq{}}\PY{o}{=\PYZgt{}} \PY{n}{psi}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
                    \PY{p}{)}\PY{p}{)}
        \PY{k}{end}
        
        \PY{c}{\PYZsh{}\PYZsh{} Run on simulated data}
        \PY{k}{using} \PY{n}{Distributions}\PY{p}{,} \PY{n}{Random}
        \PY{n}{Random}\PY{o}{.}\PY{n}{seed!}\PY{p}{(}\PY{l+m+mi}{1234}\PY{p}{)}
        
        \PY{n}{N} \PY{o}{=} \PY{k+kt}{Int}\PY{p}{(}\PY{l+m+mf}{1e3}\PY{p}{)}
        \PY{n}{dat} \PY{o}{=} \PY{n}{rand}\PY{p}{(}\PY{n}{Normal}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{,}\PY{n}{N}\PY{p}{)}
        
        \PY{c}{\PYZsh{}\PYZsh{} function calls using different types of arguments}
        \PY{n}{median}\PY{p}{(}\PY{n}{dat}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}1}]:} -0.2880149883794124
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{mm\PYZus{}median}\PY{p}{(}\PY{n}{dat}\PY{p}{,} \PY{l+m+mf}{1e\PYZhy{}9}\PY{p}{)}\PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{d}\PY{l+s}{i}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{\PYZdq{}}\PY{p}{]}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}2}]:} -0.2327764134562274
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{mm\PYZus{}median}\PY{p}{(}\PY{n}{dat}\PY{p}{,} \PY{n}{maxit}\PY{o}{=}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{d}\PY{l+s}{i}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{\PYZdq{}}\PY{p}{]}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}3}]:} -0.21952663270908485
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{mm\PYZus{}median}\PY{p}{(}\PY{n}{dat}\PY{p}{,} \PY{l+m+mf}{1e\PYZhy{}9}\PY{p}{,}\PY{n}{maxit}\PY{o}{=}\PY{l+m+mi}{100}\PY{p}{)}\PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{d}\PY{l+s}{i}\PY{l+s}{a}\PY{l+s}{n}\PY{l+s}{\PYZdq{}}\PY{p}{]}
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}4}]:} -0.2812122997253034
\end{Verbatim}
...
\tightlist
\item
  Write programs as a series of functions because: functions are
  testable and reusable, they have well-defined inputs and outputs, and
  code inside funtions usually runs much faster because of how the Julia
  compiler works.
\item
  Functions should not operate on global variables.
\item
  Functions with \texttt{!} at the end of their names modify their
  auguments instead of copying them. Julia library functions often come
  in two versions, distinguished by the \texttt{!}.
\item
  Pass a function directly, do not wrap it in anonymous function.
\item
  When writing functions that take numbers as arguments, usethe
  \texttt{Int} type when possible. When combined in numerical
  computations, they change the resulting Julia type of the result less
  frequently. This is known as type promotion.
\item
  If functino arguments have specific types, the functino call should
  force its arguments to the required type.
\end{enumerate}

The aforementioned tips are illustrated in the following code block.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c}{\PYZsh{}\PYZsh{} Tip3: functino with a `!` in the name}
        \PY{n}{a1} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{]}
        \PY{n}{sort!}\PY{p}{(}\PY{n}{a1}\PY{p}{)}
        \PY{n}{a1}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}5}]:} 6-element Array\{Int64,1\}:
         1
         2
         2
         3
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c}{\PYZsh{}\PYZsh{} Tip4: Don\PYZsq{}t warp abs() in an anonymous function}
        \PY{n}{A} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5}\PY{p}{,}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mf}{0.5}\PY{p}{]}
        \PY{n}{map}\PY{p}{(}\PY{n}{x} \PY{o}{\PYZhy{}}\PY{o}{\PYZgt{}} \PY{n}{abs}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{,} \PY{n}{A}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}6}]:} 4-element Array\{Float64,1\}:
         1.0
         0.5
         2.0
         0.5
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c}{\PYZsh{}\PYZsh{} Rather, do this }
        \PY{c}{\PYZsh{}\PYZsh{} abs() is not wrapped in an anonymous functino}
        \PY{n}{map}\PY{p}{(}\PY{n}{abs}\PY{p}{,} \PY{n}{A}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}7}]:} 4-element Array\{Float64,1\}:
         1.0
         0.5
         2.0
         0.5
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c}{\PYZsh{}\PYZsh{}Tip5: Type promotion}
         \PY{n}{times1a}\PY{p}{(}\PY{n}{y}\PY{p}{)} \PY{o}{=} \PY{o}{*}\PY{p}{(}\PY{n}{y}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{times1b}\PY{p}{(}\PY{n}{y}\PY{p}{)} \PY{o}{=} \PY{o}{*}\PY{p}{(}\PY{n}{y}\PY{p}{,} \PY{l+m+mf}{1.0}\PY{p}{)}
         \PY{n}{println}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{1}\PY{l+s}{a}\PY{l+s}{(}\PY{l+s}{1}\PY{l+s}{/}\PY{l+s}{2}\PY{l+s}{)}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{n}{times1a}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
         \PY{n}{println}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{1}\PY{l+s}{a}\PY{l+s}{(}\PY{l+s}{2}\PY{l+s}{)}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{times1a}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)} \PY{c}{\PYZsh{}\PYZsh{} preserves tyoe}
         \PY{n}{println}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{1}\PY{l+s}{a}\PY{l+s}{(}\PY{l+s}{2}\PY{l+s}{.}\PY{l+s}{0}\PY{l+s}{)}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{times1a}\PY{p}{(}\PY{l+m+mf}{2.0}\PY{p}{)}\PY{p}{)}
         \PY{n}{println}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{1}\PY{l+s}{b}\PY{l+s}{(}\PY{l+s}{1}\PY{l+s}{/}\PY{l+s}{2}\PY{l+s}{)}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{times1b}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
         \PY{n}{println}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{1}\PY{l+s}{b}\PY{l+s}{(}\PY{l+s}{2}\PY{l+s}{)}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{times1b}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)} \PY{c}{\PYZsh{}\PYZsh{} changes type}
         \PY{n}{println}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{i}\PY{l+s}{m}\PY{l+s}{e}\PY{l+s}{s}\PY{l+s}{1}\PY{l+s}{b}\PY{l+s}{(}\PY{l+s}{2}\PY{l+s}{.}\PY{l+s}{0}\PY{l+s}{)}\PY{l+s}{:}\PY{l+s}{ }\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{times1b}\PY{p}{(}\PY{l+m+mf}{2.0}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
times1b(2.0): 2.0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c}{\PYZsh{}\PYZsh{} tip6: functino with tyoed arguments}
         \PY{n}{times1c}\PY{p}{(}\PY{n}{y}\PY{o}{::}\PY{k+kt}{Float64}\PY{p}{)} \PY{o}{=} \PY{o}{*}\PY{p}{(}\PY{n}{y}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{times1c}\PY{p}{(}\PY{n}{float}\PY{p}{(}\PY{l+m+mi}{23}\PY{p}{)}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}15}]:} 23.0
\end{Verbatim}
